...
def parse_args():
    ...
    # Model
    parser.add_argument('--model', type=str, default='olmo2/32b', help='Format: family/scale')
    ...
    parser.add_argument('--adapter_configs', type=str, nargs='+',
                        # default=[
                        #     '64,64,64,64,64',       # 1. Baseline -> 4096 (100%)
                        #     '-1,105,105,105,-1',  # 3. 中间宽幅 (Seg 2-4, 39L): 105*39=4095 ≈ 4096
                        #     '-1,-1,315,-1,-1',      # 2. 中间单峰 (Seg 3, 13L): 315*13=4095 ≈ 4096
                        #     # '-1,157,157,-1,-1',     # 4. 中间靠左+ (Seg 2-3, 26L): 157*26=4082 ≈ 4096
                        #     # '-1,315,-1,-1,-1',      # 5. 中间靠左 (Seg 2, 13L): 315*13=4095 ≈ 4096
                        #     # '-1,-1,157,157,-1',     # 6. 中间靠右+ (Seg 3-4, 26L): 157*26=4082 ≈ 4096
                        #     # '-1,-1,-1,315,-1',      # 7. 中间靠右 (Seg 4, 13L): 315*13=4095 ≈ 4096
                        #     # '-1,-1,-1,-1,315',      # 8. 高层强化 (Seg 5, 13L): 315*13=4095 ≈ 4096
                        #     # '341,-1,-1,-1,-1',      # 9. 低层强化 (Seg 1, 12L): 341*12=4092 ≈ 4096
                        # ],
                        default = [
                            '8,8,8,8,8',  # 1. Baseline -> 512
                            '-1,-1,39,-1,-1',  # 2. 中间单峰 (Seg 3, 13L): 39*13=507 ≈ 512
                            '-1,13,13,13,-1',  # 3. 中间宽幅 (Seg 2-4, 39L): 13*39=507 ≈ 512
                            '-1,19,19,-1,-1',  # 4. 中间靠左+ (Seg 2-3, 26L): 19*26=494 ≈ 512
                            '-1,39,-1,-1,-1',  # 5. 中间靠左 (Seg 2, 13L): 39*13=507 ≈ 512
                            '-1,-1,19,19,-1',  # 6. 中间靠右+ (Seg 3-4, 26L): 19*26=494 ≈ 512
                            '-1,-1,-1,39,-1',  # 7. 中间靠右 (Seg 4, 13L): 39*13=507 ≈ 512
                            '-1,-1,-1,-1,39',  # 8. 高层强化 (Seg 5, 13L): 39*13=507 ≈ 512
                            '42,-1,-1,-1,-1',  # 9. 低层强化 (Seg 1, 12L): 42*12=504 ≈ 512
                        ],
